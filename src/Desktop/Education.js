...
const Education = () => {
  return (
    <>
      <div className="bg-white text-black p-5 px-10 w-full h-[100%] flex flex-col ">
        <div className="bg-white text-black g-black px-40 flex m-5 justify-between items-center gap-10">
          <div className="flex flex-col bg-white text-black  text-5xl p-10 gap-2">
            Education
            <motion.div
        ...
        <div className="grid grid-cols-2 gap-10 w-[100%] text-white justify-center items-center ">
          <div className="relative flex flex-col border-4 border-black h-[50rem] rounded-xl pl-[5rem] bg-black">
            <motion.div
              className="absolute border-2 left-[6rem] top-[70px]  border-[red]"
              animate={{
                height: ["0%", "80%"],
              }}
              transition={{
          ...
          <div className="relative flex border-4 border-black h-[50rem] rounded-xl pl-[5rem] bg-black">
            <motion.div
